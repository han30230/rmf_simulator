...
export PASSING_BAY_RUNTIME_NAME=p4_passing_bay_staging_1v3
export PASSING_BAY_DISPATCH_SCRIPT=t4_dispatch_passing_bay_staging_1v3.sh

exec "${script_dir}/start_p4_passing_bay.sh" AGV_A1 AGV_B1 AGV_B2 AGV_B3
